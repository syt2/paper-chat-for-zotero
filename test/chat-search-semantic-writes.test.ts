  ...
  async queryAsync(
    ...
    if (statement.startsWith("INSERT INTO messages")) {
      const message: StoredMessage = {
        ...
        quoted_messages: (params[8] as string | null) || null,
        timestamp: Number(params[9]),
        pdf_context: (params[10] as number | null) || null,
        selected_text: (params[11] as string | null) || null,
        tool_calls: (params[12] as string | null) || null,
        tool_call_id: (params[13] as string | null) || null,
        evidence: (params[14] as string | null) || null,
        source_item_keys: (params[15] as string | null) || null,
        streaming_state:
          (params[16] as StoredMessage["streaming_state"]) || null,
        api_only: (params[17] as number | null) || null,
