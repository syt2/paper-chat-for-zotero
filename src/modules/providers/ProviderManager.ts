...
export const BUILTIN_PROVIDERS: Record<BuiltinProviderId, ProviderMetadata> = {
  pdfaitalk: {
    ...
    defaultModelInfos: [
      ...
      { modelId: "claude-3-7-sonnet-20250219", contextWindow: 200000, maxOutput: 64000, capabilities: ["vision", "reasoning", "tool_use"] },
      { modelId: "deepseek-ai/DeepSeek-V3", contextWindow: 64000, maxOutput: 8192, capabilities: ["tool_use"] },
      { modelId: "deepseek-ai/DeepSeek-R1", contextWindow: 64000, maxOutput: 8192, capabilities: ["reasoning"] },
      { modelId: "Qwen/Qwen3-235B-A22B-Instruct-2507", contextWindow: 128000, maxOutput: 8192, capabilities: ["tool_use"] },
      { modelId: "Qwen/Qwen3-32B", contextWindow: 128000, maxOutput: 8192, capabilities: ["tool_use"] },
      { modelId: "zai-org/GLM-4.6", contextWindow: 128000, maxOutput: 8192, capabilities: ["vision", "tool_use"] },
      { modelId: "moonshotai/Kimi-K2-Instruct-0905", contextWindow: 128000, maxOutput: 8192, capabilities: ["tool_use"] },
    ],
