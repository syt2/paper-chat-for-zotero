...
paperchat-chat-quick-phrases = 快捷短语
paperchat-chat-quick-phrases-add = 添加快捷短语
paperchat-chat-quick-phrases-empty = 还没有快捷短语
paperchat-chat-quick-phrases-input = 输入短语后按回车保存
paperchat-chat-quick-phrases-limit = 已达上限，最多 { $max } 条
paperchat-chat-quick-phrases-remove = 删除「{ $phrase }」
paperchat-chat-quick-phrases-preset-summarize = 总结一下这篇论文
paperchat-chat-quick-phrases-preset-contributions = 这篇论文的核心贡献是什么
paperchat-chat-quick-phrases-preset-limitations = 这篇论文有什么局限
