...
paperchat-chat-summarize-conversation-note-prompt = 请将当前对话整理为一篇简洁、结构清晰的 Zotero 笔记，保留关键问题、结论和必要细节，然后使用 create_note 工具创建笔记。
...
paperchat-chat-summarize-reply-note-prompt = 请将下面这条 AI 回复整理为一篇简洁、结构清晰的 Zotero 笔记，保留关键结论和必要细节，然后使用 create_note 工具创建笔记。
