...
paperchat-chat-reader-ask = 问 AI
paperchat-chat-reader-ask-tooltip = 就选中的文本向 AI 提问
...
paperchat-chat-presentation-progress-resume-failed = 无法恢复 PPT 制作
...
paperchat-presentation-style-academic = 学术答辩
...
paperchat-presentation-cost-warning-title = 高 Token 消耗提示
paperchat-presentation-cost-warning-message = PaperChat 将分析论文、规划页面、处理图表并多次渲染检查，可能消耗大量 Token，且耗时较长。
