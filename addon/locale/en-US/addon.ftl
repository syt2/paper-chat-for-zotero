...
paperchat-chat-summarize-conversation-note-prompt = Summarize the current conversation into a concise, well-structured Zotero note. Preserve the key questions, conclusions, and necessary details, then use the create_note tool to create the note.
...
paperchat-chat-summarize-reply-note-prompt = Summarize the AI reply below into a concise, well-structured Zotero note. Preserve its key conclusions and necessary details, then use the create_note tool to create the note.
