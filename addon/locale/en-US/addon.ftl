...
paperchat-chat-quick-phrases = Quick phrases
paperchat-chat-quick-phrases-add = Add a quick phrase
paperchat-chat-quick-phrases-empty = No quick phrases yet
paperchat-chat-quick-phrases-input = Type a phrase, then press Enter
paperchat-chat-quick-phrases-limit = Limit reached — { $max } quick phrases
paperchat-chat-quick-phrases-remove = Remove "{ $phrase }"
paperchat-chat-quick-phrases-preset-summarize = Summarize this paper
paperchat-chat-quick-phrases-preset-contributions = What are this paper's main contributions?
paperchat-chat-quick-phrases-preset-limitations = What are this paper's limitations?
