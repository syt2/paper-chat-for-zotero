...
paperchat-chat-reader-ask-tooltip = Ask AI Paper Chat about the selected text
...
paperchat-presentation-settings-description = Choose the length and visual style for this presentation. PaperChat creates the cover automatically and organizes the remaining slides from the current paper.
...
paperchat-presentation-style-academic = Academic Defense
paperchat-presentation-style-editorial = Clean Editorial
paperchat-presentation-style-dark = Dark Presentation
paperchat-presentation-cost-warning-title = High Token Usage
paperchat-presentation-cost-warning-message = PaperChat will analyze the paper, plan slides, process figures, and run several render checks. This may consume many tokens and take some time.
