...
paperchat-chat-image-attachment-limit = Could not attach the image. Each image must be no larger than 1 MiB; a draft can contain up to 6 images and 4 MiB total.
