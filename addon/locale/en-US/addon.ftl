...
paperchat-auth-two-factor-required = This account requires two-step verification. Open the login window to complete it.
paperchat-auth-two-factor-code = Verification code or backup code
paperchat-auth-two-factor-description = Enter the current code from your authenticator, or an unused backup code.
paperchat-auth-two-factor-verify = Verify and log in
paperchat-auth-two-factor-back = Back to password login
paperchat-auth-two-factor-failed = Verification failed. Check your code and try again.
paperchat-auth-two-factor-expired = Login verification has expired. Log in again with your username and password.
paperchat-auth-verification-unsupported = This account requires another verification method. Use the website to sign in. The plugin currently supports authenticator and backup codes.
paperchat-auth-login-cancelled = Login cancelled.
paperchat-auth-zotero-login = Sign in with Zotero
paperchat-auth-zotero-reopen = Reopen the Zotero authorization page
paperchat-auth-or = or
paperchat-auth-zotero-opening = Opening the Zotero authorization page…
paperchat-auth-zotero-login-failed = Zotero sign-in failed
paperchat-auth-zotero-unavailable = Zotero sign-in is unavailable, use your account password
paperchat-auth-zotero-authorization-timeout = Zotero authorization was not completed, please try again
...
paperchat-chat-toolbar-running = Conversation in progress
paperchat-chat-toolbar-completed = Conversation ended — click to view
...
paperchat-chat-attachment-reveal = Show in file manager
paperchat-chat-attachment-reveal-copy = Show saved attachment copy (original location not recorded)
paperchat-chat-attachment-preview-image = View full image
paperchat-chat-attachment-close-preview = Close image preview
paperchat-chat-attachment-unsupported = Unsupported attachment “{ $name }”. Use an image (PNG/JPG/GIF/WebP/BMP) or text file (TXT/MD/JSON/XML/CSV/LOG).
paperchat-chat-attachment-read-failed = Could not read attachment “{ $name }”. Check that the file is accessible.
paperchat-chat-attachment-drop-unavailable = Could not read the dropped file. Drag a local file from your file manager or use Upload File.
paperchat-chat-history = Chat History
paperchat-chat-reader-figure-screenshot = Select PDF screenshot
paperchat-chat-reader-figure-screenshot-no-pdf = Open a rendered PDF page in the reader before selecting a screenshot.
...
paperchat-chat-pin-selected-text = Pin selected text
...
paperchat-chat-edit-message = Edit message
paperchat-chat-edit-message-send = Send again
paperchat-chat-edit-message-unavailable = This message cannot be edited right now. Wait for the current turn to finish and try again.
...
paperchat-chat-resume-reply = Continue reply
...
paperchat-chat-summarize-reply-note = Summarize this reply to note
...
paperchat-chat-output-truncated = The provider stopped before completing this response. The reply may be incomplete.
...
paperchat-chat-presentation-progress-interrupted = PPT generation is paused. Resume to continue from saved progress.
paperchat-chat-presentation-progress-resume = Resume presentation
...
paperchat-chat-presentation-progress-resuming = Resuming…
paperchat-chat-presentation-progress-resume-failed = Could not resume PPT
...
paperchat-chat-reader-comment = Comment on the selection
paperchat-chat-reader-comment-placeholder = Any questions about the selected passage?
paperchat-chat-reader-comment-send = Send
paperchat-chat-reader-comment-attach = Add to draft
paperchat-chat-reader-comment-cancel = Cancel
