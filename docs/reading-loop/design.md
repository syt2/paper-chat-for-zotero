...
4. `text_selected`: current selection
5. `highlight_digest`: accumulated highlights
6. `reading_checkpoint`: session end summary
7. page dwell based suggestions
